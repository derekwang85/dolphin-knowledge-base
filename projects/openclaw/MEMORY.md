...
## 2026-06-29 — Coding 十诫沉淀

Derek 分享了 10 条 Coding 规则（READ BEFORE YOU WRITE / THINK BEFORE YOU CODE / SIMPLICITY / SURGICAL CHANGES / VERIFICATION / GOAL-DRIVEN EXECUTION / DEBUGGING / DEPENDENCIES / COMMUNICATION / COMMON FAILURE MODES）。
已经落地到：AGENTS.md + CONSTITUTION.md 附录B + derekcoding-multiagent SKILL.md。
子 Agent 派发时自动注入。
